...
{
   ros::init(argc, argv, "data_to_vision_4");
   ros::NodeHandle n;
   ...
   while(ros::ok()){
       ...
       msg.pose.position.x = 1;//0.001*some_object.position_x;
       msg.pose.position.y = 2;//0.001*some_object.position_y;
       msg.pose.position.z = .2;//0.001*some_object.position_z;
