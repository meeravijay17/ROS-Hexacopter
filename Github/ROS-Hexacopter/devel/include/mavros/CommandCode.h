// Generated by gencpp from file mavros/CommandCode.msg
// DO NOT EDIT!


#ifndef MAVROS_MESSAGE_COMMANDCODE_H
#define MAVROS_MESSAGE_COMMANDCODE_H
...
struct CommandCode_
{
  ...
  typedef boost::shared_ptr< ::mavros::CommandCode_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::mavros::CommandCode_<ContainerAllocator> const> ConstPtr;

}; // struct CommandCode_

typedef ::mavros::CommandCode_<std::allocator<void> > CommandCode;

typedef boost::shared_ptr< ::mavros::CommandCode > CommandCodePtr;
typedef boost::shared_ptr< ::mavros::CommandCode const> CommandCodeConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::mavros::CommandCode_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::mavros::CommandCode_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::mavros::CommandCode_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::mavros::CommandCode_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mavros::CommandCode_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::mavros::CommandCode_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mavros::CommandCode_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::mavros::CommandCode_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::mavros::CommandCode_<ContainerAllocator> >
{
  ...
  static const char* value(const ::mavros::CommandCode_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xf7e54ea3892a961cULL;
  static const uint64_t static_value2 = 0xc44c9350fdb0855eULL;
};

template<class ContainerAllocator>
struct DataType< ::mavros::CommandCode_<ContainerAllocator> >
{
  static const char* value()
  {
    return "mavros/CommandCode";
  }
...
template<class ContainerAllocator>
struct Definition< ::mavros::CommandCode_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::mavros::CommandCode_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::mavros::CommandCode_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream&, const std::string&, const ::mavros::CommandCode_<ContainerAllocator>&)
  {}
};
...
#endif // MAVROS_MESSAGE_COMMANDCODE_H
