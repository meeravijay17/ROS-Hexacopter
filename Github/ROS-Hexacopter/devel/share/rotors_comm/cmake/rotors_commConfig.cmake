...
if("TRUE" STREQUAL "TRUE")
  set(rotors_comm_SOURCE_PREFIX /home/mahesh/catkin_ws/src/rotors_simulator/rotors_comm)
  set(rotors_comm_DEVEL_PREFIX /home/mahesh/catkin_ws/devel)
  ...
  set(rotors_comm_INSTALL_PREFIX /home/mahesh/catkin_ws/install)
...
if(NOT "/home/mahesh/catkin_ws/devel/include " STREQUAL " ")
  set(rotors_comm_INCLUDE_DIRS "")
  set(_include_dirs "/home/mahesh/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rotors_comm' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mahesh/catkin_ws/src/rotors_simulator/rotors_comm/${idir}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>' to fix it.")
    endif()
...
set(rotors_comm_EXPORTED_TARGETS "rotors_comm_generate_messages_cpp;rotors_comm_generate_messages_lisp;rotors_comm_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rotors_comm_dep}_FOUND)
      find_package(${rotors_comm_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rotors_comm_dep} REQUIRED ${depend_list})
  endif()
