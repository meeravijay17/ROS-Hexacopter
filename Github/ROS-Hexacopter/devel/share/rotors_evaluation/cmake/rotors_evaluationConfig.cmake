...
if("TRUE" STREQUAL "TRUE")
  set(rotors_evaluation_SOURCE_PREFIX /home/mahesh/catkin_ws/src/rotors_simulator/rotors_evaluation)
  set(rotors_evaluation_DEVEL_PREFIX /home/mahesh/catkin_ws/devel)
  ...
  set(rotors_evaluation_INSTALL_PREFIX /home/mahesh/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rotors_evaluation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mahesh/catkin_ws/src/rotors_simulator/rotors_evaluation/${idir}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rotors_evaluation_dep}_FOUND)
      find_package(${rotors_evaluation_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rotors_evaluation_dep} REQUIRED ${depend_list})
  endif()
