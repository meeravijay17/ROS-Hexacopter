...
;//! \htmlinclude CommandTrajectoryPositionYaw.msg.html

(cl:defclass <CommandTrajectoryPositionYaw> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass CommandTrajectoryPositionYaw (<CommandTrajectoryPositionYaw>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <CommandTrajectoryPositionYaw>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'CommandTrajectoryPositionYaw)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mav_msgs-msg:<CommandTrajectoryPositionYaw> is deprecated: use mav_msgs-msg:CommandTrajectoryPositionYaw instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod position-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod velocity-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod acceleration-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod jerk-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod snap-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod yaw-val ((m <CommandTrajectoryPositionYaw>))
...
(cl:defmethod yaw_rate-val ((m <CommandTrajectoryPositionYaw>))
  ...
  (yaw_rate m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <CommandTrajectoryPositionYaw>) ostream)
  "Serializes a message object of type '<CommandTrajectoryPositionYaw>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <CommandTrajectoryPositionYaw>) istream)
  "Deserializes a message object of type '<CommandTrajectoryPositionYaw>"
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CommandTrajectoryPositionYaw>)))
  "Returns string type for a message object of type '<CommandTrajectoryPositionYaw>"
  "mav_msgs/CommandTrajectoryPositionYaw")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommandTrajectoryPositionYaw)))
  "Returns string type for a message object of type 'CommandTrajectoryPositionYaw"
  "mav_msgs/CommandTrajectoryPositionYaw")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CommandTrajectoryPositionYaw>)))
  "Returns md5sum for a message object of type '<CommandTrajectoryPositionYaw>"
  "1993f299145e41178a7764791630d855")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CommandTrajectoryPositionYaw)))
  "Returns md5sum for a message object of type 'CommandTrajectoryPositionYaw"
  "1993f299145e41178a7764791630d855")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommandTrajectoryPositionYaw>)))
  "Returns full string definition for message of type '<CommandTrajectoryPositionYaw>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommandTrajectoryPositionYaw)))
  "Returns full string definition for message of type 'CommandTrajectoryPositionYaw"
  (cl:format cl:nil "Header header~%~%# Message should be expressed in the frame_id specified in the header.~%~%geometry_msgs/Vector3 position      # [m]~%geometry_msgs/Vector3 velocity      # [m/s]~%geometry_msgs/Vector3 acceleration  # [m/s^2]~%geometry_msgs/Vector3 jerk          # [m/s^3]~%geometry_msgs/Vector3 snap          # [m/s^4]~%float64 yaw                         # [rad]~%float64 yaw_rate                    # [rad/s]~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <CommandTrajectoryPositionYaw>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <CommandTrajectoryPositionYaw>))
  "Converts a ROS message object to a list"
  (cl:list 'CommandTrajectoryPositionYaw
