...
(defsystem "mav_msgs-msg"
  ...
  :components ((:file "_package")
    (:file "CommandTrajectoryVelocityYawrate" :depends-on ("_package_CommandTrajectoryVelocityYawrate"))
    (:file "_package_CommandTrajectoryVelocityYawrate" :depends-on ("_package"))
    ...
    (:file "CommandTrajectoryPositionYaw" :depends-on ("_package_CommandTrajectoryPositionYaw"))
    (:file "_package_CommandTrajectoryPositionYaw" :depends-on ("_package"))
  ))