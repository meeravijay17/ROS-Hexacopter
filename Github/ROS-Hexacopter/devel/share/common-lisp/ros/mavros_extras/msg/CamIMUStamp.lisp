...
(cl:defmethod cl:initialize-instance :after ((m <CamIMUStamp>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CamIMUStamp)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros_extras-msg:<CamIMUStamp> is deprecated: use mavros_extras-msg:CamIMUStamp instead.")))

(cl:ensure-generic-function 'frame_stamp-val :lambda-list '(m))
(cl:defmethod frame_stamp-val ((m <CamIMUStamp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_extras-msg:frame_stamp-val is deprecated.  Use mavros_extras-msg:frame_stamp instead.")
  (frame_stamp m))

(cl:ensure-generic-function 'frame_seq_id-val :lambda-list '(m))
(cl:defmethod frame_seq_id-val ((m <CamIMUStamp>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_extras-msg:frame_seq_id-val is deprecated.  Use mavros_extras-msg:frame_seq_id instead.")
  (frame_seq_id m))
