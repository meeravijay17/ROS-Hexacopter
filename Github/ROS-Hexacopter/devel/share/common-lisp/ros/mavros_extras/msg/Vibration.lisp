...
(cl:defmethod cl:initialize-instance :after ((m <Vibration>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Vibration)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros_extras-msg:<Vibration> is deprecated: use mavros_extras-msg:Vibration instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Vibration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_extras-msg:header-val is deprecated.  Use mavros_extras-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'vibration-val :lambda-list '(m))
(cl:defmethod vibration-val ((m <Vibration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_extras-msg:vibration-val is deprecated.  Use mavros_extras-msg:vibration instead.")
  (vibration m))

(cl:ensure-generic-function 'clipping-val :lambda-list '(m))
(cl:defmethod clipping-val ((m <Vibration>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros_extras-msg:clipping-val is deprecated.  Use mavros_extras-msg:clipping instead.")
  (clipping m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Vibration>)))
  ...
  (cl:format cl:nil "# VIBRATION message data~%# @description: Vibration levels and accelerometer clipping~%~%Header header~%~%geometry_msgs/Vector3 vibration		# 3-axis vibration levels~%float32[3] clipping				# Accelerometers clipping~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Vibration)))
  "Returns full string definition for message of type 'Vibration"
  (cl:format cl:nil "# VIBRATION message data~%# @description: Vibration levels and accelerometer clipping~%~%Header header~%~%geometry_msgs/Vector3 vibration		# 3-axis vibration levels~%float32[3] clipping				# Accelerometers clipping~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%# 0: no frame~%# 1: global frame~%string frame_id~%~%================================================================================~%MSG: geometry_msgs/Vector3~%# This represents a vector in free space. ~%~%float64 x~%float64 y~%float64 z~%~%"))
