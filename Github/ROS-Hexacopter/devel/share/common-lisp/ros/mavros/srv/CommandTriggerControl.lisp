...
(cl:defmethod cl:initialize-instance :after ((m <CommandTriggerControl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandTriggerControl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandTriggerControl-request> is deprecated: use mavros-srv:CommandTriggerControl-request instead.")))
...
(cl:defmethod trigger_enable-val ((m <CommandTriggerControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:trigger_enable-val is deprecated.  Use mavros-srv:trigger_enable instead.")
  (trigger_enable m))
...
(cl:defmethod integration_time-val ((m <CommandTriggerControl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mavros-srv:integration_time-val is deprecated.  Use mavros-srv:integration_time instead.")
  (integration_time m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CommandTriggerControl-request>)))
  ...
  "mavros/CommandTriggerControlRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommandTriggerControl-request)))
  "Returns string type for a service object of type 'CommandTriggerControl-request"
  "mavros/CommandTriggerControlRequest")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CommandTriggerControl-request>)))
  ...
  (cl:format cl:nil "~%~%bool    trigger_enable~%float32 integration_time~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CommandTriggerControl-request)))
  "Returns full string definition for message of type 'CommandTriggerControl-request"
  (cl:format cl:nil "~%~%bool    trigger_enable~%float32 integration_time~%~%~%"))
...
(cl:defmethod cl:initialize-instance :after ((m <CommandTriggerControl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'CommandTriggerControl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mavros-srv:<CommandTriggerControl-response> is deprecated: use mavros-srv:CommandTriggerControl-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<CommandTriggerControl-response>)))
  ...
  "mavros/CommandTriggerControlResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'CommandTriggerControl-response)))
  "Returns string type for a service object of type 'CommandTriggerControl-response"
  "mavros/CommandTriggerControlResponse")
