...
if("TRUE" STREQUAL "TRUE")
  set(rotors_gazebo_plugins_SOURCE_PREFIX /home/mahesh/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins)
  set(rotors_gazebo_plugins_DEVEL_PREFIX /home/mahesh/catkin_ws/devel)
  ...
  set(rotors_gazebo_plugins_INSTALL_PREFIX /home/mahesh/catkin_ws/install)
...
if(NOT "/home/mahesh/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3 " STREQUAL " ")
  set(rotors_gazebo_plugins_INCLUDE_DIRS "")
  set(_include_dirs "/home/mahesh/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins/include;/usr/include/eigen3")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rotors_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mahesh/catkin_ws/src/rotors_simulator/rotors_gazebo_plugins/${idir}'.  Ask the maintainer 'Fadri Furrer <fadri.furrer@mavt.ethz.ch>' to fix it.")
    endif()
